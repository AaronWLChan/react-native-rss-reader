...
export default function Home() {
        ...
        if (feeds.length > 0 && hasProviders()) {
            ...
            axios.all(requests)
                .then(axios.spread((...responses) => {
                    ...
                    return parse(xmlObjects, providers.map((provider) => provider.title), sortMode, "today")
                }))
                .then((result) => {
    ...
    useFocusEffect(() => {
        dispatch(setActiveDrawerLink(ROUTES.HOME))
    })
    ...
    const renderHeader = () => {
        return (
            <View style={styles.header_container}>
                ...
                <Text style={[styles.header, { color: colors.text }]}>Today</Text>
